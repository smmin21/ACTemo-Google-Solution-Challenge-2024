...
| Screen                                                                                                                                         | Guide                                                                                                                                                                                                                                                                                                                                                                |
| ---------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <img src="https://github.com/smmin21/ACTemo-Google-Solution-Challenge-2024/assets/108079454/f5758725-fb08-4d00-9f48-c2d058845cb8"  width="300"> | Based on your input from the previous two steps, <br> we provide you a list of emotions that you may have felt. <br> <br> If you click on the arrow on the right of each list item, <br> you can check a card containing information about that specific emotion. <br> <br>  It is required that you select one of the emotions to proceed to the next step. |
